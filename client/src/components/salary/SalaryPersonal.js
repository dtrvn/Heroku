...
const SalaryPersonal = ({
    ...
    if (shifts.length > 0) {
        ...
        if (findShiftMax === 0) findShiftMax = count;
    }
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            <h4 className="text-right">{createDate.currentUser}</h4>
...
export default connect(mapStateToProps, {
    getShiftRegisterViewSalary, getShiftRegisters, getAllJobs, getAllUsers,
})(SalaryPersonal);
