        ...
        personInShifts.map((ele) => {
            ele.personShift.map((reg) => {
                ...
                if (moment(ele.date).format('YYYY-MM-DD') === moment(tuesday).format('YYYY-MM-DD')) {
                    ...
                    totalShiftsNumRule[index + 10] = reg.personNumber;
                }
                if (moment(ele.date).format('YYYY-MM-DD') === moment(wednesday).format('YYYY-MM-DD')) {
                    ...
                    totalShiftsNumRule[index + 20] = reg.personNumber;
                }
                if (moment(ele.date).format('YYYY-MM-DD') === moment(thursday).format('YYYY-MM-DD')) {
                    ...
                    totalShiftsNumRule[index + 30] = reg.personNumber;
                }
                if (moment(ele.date).format('YYYY-MM-DD') === moment(friday).format('YYYY-MM-DD')) {
                    ...
                    totalShiftsNumRule[index + 40] = reg.personNumber;
                }
                if (moment(ele.date).format('YYYY-MM-DD') === moment(saturday).format('YYYY-MM-DD')) {
                    ...
                    totalShiftsNumRule[index + 50] = reg.personNumber;
                }
                if (moment(ele.date).format('YYYY-MM-DD') === moment(sunday).format('YYYY-MM-DD')) {
                    ...
                    totalShiftsNumRule[index + 60] = reg.personNumber;
                }
            })
        });
    ...
    if (shifts.length > 0) {
        ...
        shifts.map((ele, idx) => {
            if (idx === 0) {
                ...
                classNameListTue.push(<span className="label label-success">{ele.shiftName} - {totalShiftsNum[10]} - {totalLackShiftsNum[10]}</span>);
                classNameListWed.push(<span className="label label-success">{ele.shiftName} - {totalShiftsNum[20]} - {totalLackShiftsNum[20]}</span>);
                classNameListThu.push(<span className="label label-success">{ele.shiftName} - {totalShiftsNum[30]} - {totalLackShiftsNum[30]}</span>);
                classNameListFri.push(<span className="label label-success">{ele.shiftName} - {totalShiftsNum[40]} - {totalLackShiftsNum[40]}</span>);
                classNameListSat.push(<span className="label label-success">{ele.shiftName} - {totalShiftsNum[50]} - {totalLackShiftsNum[50]}</span>);
                classNameListSun.push(<span className="label label-success">{ele.shiftName} - {totalShiftsNum[60]} - {totalLackShiftsNum[60]}</span>);
            }
            if (idx === 1) {
                classNameListMon.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[1]} - {totalLackShiftsNum[1]}</span>);
                classNameListTue.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[11]} - {totalLackShiftsNum[11]}</span>);
                classNameListWed.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[21]} - {totalLackShiftsNum[21]}</span>);
                classNameListThu.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[31]} - {totalLackShiftsNum[31]}</span>);
                classNameListFri.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[41]} - {totalLackShiftsNum[41]}</span>);
                classNameListSat.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[51]} - {totalLackShiftsNum[51]}</span>);
                classNameListSun.push(<span className="label label-info">{ele.shiftName} - {totalShiftsNum[61]} - {totalLackShiftsNum[61]}</span>);
            }
            if (idx === 2) {
                classNameListMon.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[2]} - {totalLackShiftsNum[2]}</span>);
                classNameListTue.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[12]} - {totalLackShiftsNum[12]}</span>);
                classNameListWed.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[22]} - {totalLackShiftsNum[22]}</span>);
                classNameListThu.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[32]} - {totalLackShiftsNum[32]}</span>);
                classNameListFri.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[42]} - {totalLackShiftsNum[42]}</span>);
                classNameListSat.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[52]} - {totalLackShiftsNum[52]}</span>);
                classNameListSun.push(<span className="label label-warning">{ele.shiftName} - {totalShiftsNum[62]} - {totalLackShiftsNum[62]}</span>);
            }
            if (idx === 3) {
                classNameListMon.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[3]} - {totalLackShiftsNum[3]}</span>);
                classNameListTue.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[13]} - {totalLackShiftsNum[13]}</span>);
                classNameListWed.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[23]} - {totalLackShiftsNum[23]}</span>);
                classNameListThu.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[33]} - {totalLackShiftsNum[33]}</span>);
                classNameListFri.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[43]} - {totalLackShiftsNum[43]}</span>);
                classNameListSat.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[53]} - {totalLackShiftsNum[53]}</span>);
                classNameListSun.push(<span className="label label-yellow">{ele.shiftName} - {totalShiftsNum[63]} - {totalLackShiftsNum[63]}</span>);
            }
            if (idx === 4) {
                classNameListMon.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[4]} - {totalLackShiftsNum[4]}</span>);
                classNameListTue.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[14]} - {totalLackShiftsNum[14]}</span>);
                classNameListWed.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[24]} - {totalLackShiftsNum[24]}</span>);
                classNameListThu.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[34]} - {totalLackShiftsNum[34]}</span>);
                classNameListFri.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[44]} - {totalLackShiftsNum[44]}</span>);
                classNameListSat.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[54]} - {totalLackShiftsNum[54]}</span>);
                classNameListSun.push(<span className="label label-pink">{ele.shiftName} - {totalShiftsNum[64]} - {totalLackShiftsNum[64]}</span>);
            }
            if (idx === 5) {
                classNameListMon.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[5]} - {totalLackShiftsNum[5]}</span>);
                classNameListTue.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[15]} - {totalLackShiftsNum[15]}</span>);
                classNameListWed.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[25]} - {totalLackShiftsNum[25]}</span>);
                classNameListThu.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[35]} - {totalLackShiftsNum[35]}</span>);
                classNameListFri.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[45]} - {totalLackShiftsNum[45]}</span>);
                classNameListSat.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[55]} - {totalLackShiftsNum[55]}</span>);
                classNameListSun.push(<span className="label label-green">{ele.shiftName} - {totalShiftsNum[65]} - {totalLackShiftsNum[65]}</span>);
            }
            if (idx === 6) {
                classNameListMon.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[6]} - {totalLackShiftsNum[6]}</span>);
                classNameListTue.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[16]} - {totalLackShiftsNum[16]}</span>);
                classNameListWed.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[26]} - {totalLackShiftsNum[26]}</span>);
                classNameListThu.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[36]} - {totalLackShiftsNum[36]}</span>);
                classNameListFri.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[46]} - {totalLackShiftsNum[46]}</span>);
                classNameListSat.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[56]} - {totalLackShiftsNum[56]}</span>);
                classNameListSun.push(<span className="label label-aqua">{ele.shiftName} - {totalShiftsNum[66]} - {totalLackShiftsNum[66]}</span>);
            }
            if (idx === 7) {
                classNameListMon.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[7]} - {totalLackShiftsNum[7]}</span>);
                classNameListTue.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[17]} - {totalLackShiftsNum[17]}</span>);
                classNameListWed.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[27]} - {totalLackShiftsNum[27]}</span>);
                classNameListThu.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[37]} - {totalLackShiftsNum[37]}</span>);
                classNameListFri.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[47]} - {totalLackShiftsNum[47]}</span>);
                classNameListSat.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[57]} - {totalLackShiftsNum[57]}</span>);
                classNameListSun.push(<span className="label label-violet">{ele.shiftName} - {totalShiftsNum[67]} - {totalLackShiftsNum[67]}</span>);
            }
            if (idx === 8) {
                classNameListMon.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[8]} - {totalLackShiftsNum[8]}</span>);
                classNameListTue.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[18]} - {totalLackShiftsNum[18]}</span>);
                classNameListWed.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[28]} - {totalLackShiftsNum[28]}</span>);
                classNameListThu.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[38]} - {totalLackShiftsNum[38]}</span>);
                classNameListFri.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[48]} - {totalLackShiftsNum[48]}</span>);
                classNameListSat.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[58]} - {totalLackShiftsNum[58]}</span>);
                classNameListSun.push(<span className="label label-organge">{ele.shiftName} - {totalShiftsNum[68]} - {totalLackShiftsNum[68]}</span>);
            }
            if (idx === 9) {
                classNameListMon.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[9]} - {totalLackShiftsNum[9]}</span>);
                classNameListTue.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[19]} - {totalLackShiftsNum[19]}</span>);
                classNameListWed.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[29]} - {totalLackShiftsNum[29]}</span>);
                classNameListThu.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[39]} - {totalLackShiftsNum[39]}</span>);
                classNameListFri.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[49]} - {totalLackShiftsNum[49]}</span>);
                classNameListSat.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[59]} - {totalLackShiftsNum[59]}</span>);
                classNameListSun.push(<span className="label label-blue">{ele.shiftName} - {totalShiftsNum[69]} - {totalLackShiftsNum[69]}</span>);
            }
        })
    }
